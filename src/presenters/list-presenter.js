...
class ListPresenter extends Presenter {
  ...
  * @returns {ListViewState}
   ...
   */
  addEventListeners() {
    this.view.addEventListener('open', this.handlerViewOpen.bind(this));
    this.view.addEventListener('close', this.handlerViewClose.bind(this));
    this.view.addEventListener('favorite', this.handlerViewFavorite.bind(this));
    this.view.addEventListener('edit', this.handlerViewEdit.bind(this));
    this.view.addEventListener('save', this.handlerViewSave.bind(this));
    this.view.addEventListener('delete', this.handlerViewDelete.bind(this));
  }

  /**
   * @param {CustomEvent & {target: CardView}} event
   */
  handlerViewOpen(event) {
    /** @type {UrlParams} */
    const urlParams = this.getUrlParams();
   ...
   * @param {CustomEvent & {target: CardView}} event
   */
  async handlerViewFavorite(event) {
